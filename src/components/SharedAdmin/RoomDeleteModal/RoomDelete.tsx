...
function RoomDelete({ isDeleteOpen, handleDeleteModalClose, roomId, getAllRooms }: { isDeleteOpen: boolean, handleDeleteModalClose: () => void, roomId: string | undefined, getAllRooms: () => void }) {
...
export default React.memo(RoomDelete)